...
Revision ID: 4bd1fb430e99
Revises: 
Create Date: 2024-12-27 16:38:34.756909
...
def upgrade():
    ...
    op.create_table('favorite_programs',
    sa.Column('favoriteId', sa.Integer(), nullable=False),
    sa.Column('workoutProgramId', sa.Integer(), nullable=False),
    sa.Column('createdAt', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['favoriteId'], ['favorites.id'], ),
    sa.ForeignKeyConstraint(['workoutProgramId'], ['workout_programs.id'], ),
    sa.PrimaryKeyConstraint('favoriteId', 'workoutProgramId')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('weekId', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=False),
    sa.Column('restDay', sa.Boolean(), nullable=True),
    sa.Column('createdAt', sa.DateTime(), nullable=False),
    sa.Column('updatedAt', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['weekId'], ['weeks.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('days')
    op.drop_table('weeks')
    op.drop_table('favorite_programs')
