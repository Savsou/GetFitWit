...
class SignUpForm(FlaskForm):
    ...
    confirm_password = StringField('Confirm Password', validators=[DataRequired(message="Confirm Password is required"), EqualTo('password', message='Password must match')]
    )
